...
para comparar DDQN propio vs DQN oficial de SB3.

Compara el rendimiento FINAL de cada corrida:
- DDQN propio: último eval_mean_return de cada eval_log.csv
- SB3 DQN: promedio del último bloque de evaluación en evaluations.npz

Ejemplo:
python pairwise_stats_ddqn_vs_sb3.py \
...
def main():
    ...
    desc = pd.DataFrame([
        describe(ours, "DDQN propio"),
        describe(sb3, "DQN oficial SB3"),
    ])
